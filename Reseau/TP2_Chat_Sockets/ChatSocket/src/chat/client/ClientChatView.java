...
public class ClientChatView extends javax.swing.JFrame {
    ...
    public void displayMessage(Message m) {
        ...
        if(sender.compareTo(client.getUserName())==0){
            sender = "me";
        } else if(receiver.compareTo(client.getUserName())==0){
            receiver = "me";
        }
        sb.append(String.format("%s > %s : %s", sender, receiver, m.getTextMessage()));
        sb.append("\n");
    ...
    private void sendMessage(){
        if (client.isConnected() && clientsList.getSelectedValue()!=null) {
            client.sendMessage(clientsList.getSelectedValue().toString(),messageTextArea.getText());
    ...
    void addUser(String c) {
        if (c.compareTo(client.getUserName())==0) {
            //users.add(0, "You (" + c + ")");
        } else {
            users.addElement(c);
        }
    ...
    void removeUser(String c) {
        if (c.compareTo(client.getUserName())==0) {
            users.removeAllElements();
        } else {
            users.removeElement(c);
        }
    }
