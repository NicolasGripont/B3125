...
public class JeuDeDonnees {
        public static void main(String[] args) { 
            ...
            Livreur lv4 = new LivreurVelo("Martin", "Damien", "estelle@livreur.com", "mdp", "200 Rue Léon Blum, 69100 Villeurbanne", new Double(20000.F));
            lv4.setCoordonnees(GeoTest.getLatLng(lv4.getAdresse()));
            Livreur lv5 = new LivreurVelo("Roux", "Estelle", "estelle@livreur.com", "mdp", "146 Boulevard Pinel, 69008 Lyon", new Double(10000.F));
            lv5.setCoordonnees(GeoTest.getLatLng(lv5.getAdresse()));
            
            Livreur ld1 = new LivreurDrone(new Double(10.F), "drone@gmail.com", "mdp", "17 Rue du Dr Bouchut, 69003 Lyon", new Double(1000.F));
            ld1.setCoordonnees(GeoTest.getLatLng(ld1.getAdresse()));
            Livreur ld2 = new LivreurDrone(new Double(10.F), "drone@gmail.com", "mdp", "17 Rue du Dr Bouchut, 69003 Lyon", new Double(1000.F));
            ld2.setCoordonnees(GeoTest.getLatLng(ld2.getAdresse()));
            Livreur ld3 = new LivreurDrone(new Double(10.F), "drone@gmail.com", "mdp", "17 Rue du Dr Bouchut, 69003 Lyon", new Double(1000.F));
            ld3.setCoordonnees(GeoTest.getLatLng(ld3.getAdresse()));
            Livreur ld4 = new LivreurDrone(new Double(10.F), "drone@gmail.com", "mdp", "17 Rue du Dr Bouchut, 69003 Lyon", new Double(1000.F));
            ld4.setCoordonnees(GeoTest.getLatLng(ld4.getAdresse()));
            Livreur ld5 = new LivreurDrone(new Double(10.F), "drone@gmail.com", "mdp", "17 Rue du Dr Bouchut, 69003 Lyon", new Double(1000.F));
